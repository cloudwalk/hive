...
//
// Solidity: function constFunc(uint256 a, uint256 b, uint256 c) view returns(uint256, uint256, uint256)
...
//
// Solidity: function getFromMap(address addr) view returns(uint256)
...
//
// Solidity: function ui() view returns(uint256)
